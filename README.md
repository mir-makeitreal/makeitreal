...
> *The Architecture Dossier — generated by `/mir:plan`. Module graph, frozen contracts, task dependency order, acceptance criteria. All cross-linked, all machine-checkable.*
